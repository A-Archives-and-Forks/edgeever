...
export const ARCHITECTURE_SURFACES: Record<ArchitectureAppearance, ArchitectureSurface> = {
  light: {
    ...
    boundaryText: "#1C3D31",
    nodes: {
      client: { fill: "#C9E7EE", stroke: "#0A87A6", text: "#134F5D", accent: "#0891B2", iconFrame: "#A1D5E2" },
      frontend: { fill: "#CFDDFB", stroke: "#245DDA", text: "#203A76", accent: "#2563EB", iconFrame: "#ACC4F7" },
      service: { fill: "#CCEADF", stroke: "#169567", text: "#19563E", accent: "#16A06E", iconFrame: "#A6DBC8" },
      database: { fill: "#E2D4FB", stroke: "#7437DC", text: "#472877", accent: "#7C3AED", iconFrame: "#CDB4F8" },
      storage: { fill: "#F7E1C8", stroke: "#CA6F07", text: "#71430F", accent: "#D97706", iconFrame: "#F1CBA0" },
      queue: { fill: "#FADACA", stroke: "#DA530D", text: "#793512", accent: "#EA580C", iconFrame: "#F7C0A3" },
      security: { fill: "#F8CDD7", stroke: "#D11D44", text: "#751B2D", accent: "#E11D48", iconFrame: "#F4A9B9" },
      external: { fill: "#DDE0E5", stroke: "#5E6D82", text: "#3C424B", accent: "#64748B", iconFrame: "#C4CAD3" },
    },
    edges: {
