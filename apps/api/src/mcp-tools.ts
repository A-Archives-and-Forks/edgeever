  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        theme: { type: "string", enum: ["brand", "sun", "wa", "island", "rose", "mint", "cosmos", "tea", "naive", "macaron", "ocean", "ink", "classic"] },
        structure: { type: "string", enum: ["map", "line", "capsule", "box", "circle", "ellipse", "hexagon", "logic", "tree", "brace"] },
        layout: {
          type: "object",
          additionalProperties: false,
          properties: {
